...
from .mahasiswa import Mahasiswa  # Import model Mahasiswa
from .mymodel import MyModel  # Import model MyModel
from .matakuliah import Matakuliah  # Import model Matakuliah
